...
class CustomBlocksWidget extends StatelessWidget {
  const CustomBlocksWidget({super.key});
  ...
  Widget _buildBlock({required String imageUrl, required String iconUrl, required String text, required int type}) {
    return Container(
      height: 300,
